...
alter table professor add constraint fk_professor_user_20 foreign key (user_email) references account (email) on delete restrict on update restrict;
create index ix_professor_user_20 on professor (user_email);
alter table professor_content add constraint fk_professor_content_professo_21 foreign key (professor_id) references professor (id) on delete restrict on update restrict;
create index ix_professor_content_professo_21 on professor_content (professor_id);
...
alter table question add constraint fk_question_subtopic_25 foreign key (subtopic_id) references curriculummodule (id) on delete restrict on update restrict;
create index ix_question_subtopic_25 on question (subtopic_id);
alter table question_evaluation add constraint fk_question_evaluation_userte_26 foreign key (usertest_id) references usertest (id) on delete restrict on update restrict;
create index ix_question_evaluation_userte_26 on question_evaluation (usertest_id);
alter table question_evaluation add constraint fk_question_evaluation_questi_27 foreign key (question_id) references question (id) on delete restrict on update restrict;
create index ix_question_evaluation_questi_27 on question_evaluation (question_id);
alter table question_evaluation add constraint fk_question_evaluation_answer_28 foreign key (answer_id) references answer (id) on delete restrict on update restrict;
create index ix_question_evaluation_answer_28 on question_evaluation (answer_id);
alter table question_evaluation add constraint fk_question_evaluation_profes_29 foreign key (professormarker_id) references professor (id) on delete restrict on update restrict;
create index ix_question_evaluation_profes_29 on question_evaluation (professormarker_id);
alter table question_group add constraint fk_question_group_test_30 foreign key (test_id) references test (id) on delete restrict on update restrict;
create index ix_question_group_test_30 on question_group (test_id);
alter table reply add constraint fk_reply_topic_31 foreign key (topic_id) references topic (id) on delete restrict on update restrict;
create index ix_reply_topic_31 on reply (topic_id);
alter table reply add constraint fk_reply_user_32 foreign key (user_email) references account (email) on delete restrict on update restrict;
create index ix_reply_user_32 on reply (user_email);
alter table subtopic_reputation add constraint fk_subtopic_reputation_subtop_33 foreign key (subtopic_id) references curriculummodule (id) on delete restrict on update restrict;
create index ix_subtopic_reputation_subtop_33 on subtopic_reputation (subtopic_id);
alter table subtopic_reputation add constraint fk_subtopic_reputation_user_34 foreign key (user_email) references account (email) on delete restrict on update restrict;
create index ix_subtopic_reputation_user_34 on subtopic_reputation (user_email);
alter table test add constraint fk_test_lesson_35 foreign key (lesson_id) references lesson (id) on delete restrict on update restrict;
create index ix_test_lesson_35 on test (lesson_id);
alter table topic add constraint fk_topic_forum_36 foreign key (forum_id) references forum (id) on delete restrict on update restrict;
create index ix_topic_forum_36 on topic (forum_id);
alter table url add constraint fk_url_question_37 foreign key (question_id) references question (id) on delete restrict on update restrict;
create index ix_url_question_37 on url (question_id);
alter table url add constraint fk_url_user_38 foreign key (user_email) references account (email) on delete restrict on update restrict;
create index ix_url_user_38 on url (user_email);
alter table university add constraint fk_university_continent_39 foreign key (continent_id) references continent (id) on delete restrict on update restrict;
create index ix_university_continent_39 on university (continent_id);
alter table account add constraint fk_account_professorProfile_40 foreign key (professor_profile_id) references professor (id) on delete restrict on update restrict;
create index ix_account_professorProfile_40 on account (professor_profile_id);
alter table usertest add constraint fk_usertest_user_41 foreign key (user_email) references account (email) on delete restrict on update restrict;
create index ix_usertest_user_41 on usertest (user_email);
alter table usertest add constraint fk_usertest_test_42 foreign key (test_id) references test (id) on delete restrict on update restrict;
create index ix_usertest_test_42 on usertest (test_id);
