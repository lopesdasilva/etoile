...
(function (factory) {
  ...
  $.fn.tweet = function(o){
    ...
    function format_relative_time(time_ago) {
      if ( time_ago.days > 2 )     return time_ago.days + 'd';
      if ( time_ago.hours > 24 )   return '1d';
      if ( time_ago.hours > 2 )    return time_ago.hours + 'h';
      if ( time_ago.minutes > 45 ) return '1h';
      if ( time_ago.minutes > 2 )  return time_ago.minutes + 'm';
      if ( time_ago.seconds > 1 )  return time_ago.seconds + 's';
      return 'just now';
    }
/*
    function format_relative_time(time_ago) {
